...
Automatically set Fcstday=DAY3 and MAP Type = mean vs Lead Time if statistic = ME or RMSE 
...
var url = "https://www.emc.ncep.noaa.gov/mmb/aq/fvs/SSSYY/OZMX-LLLSFC_VVVPPP_AQMDDD.gif";
...
variables.push({
        displayName: "Probability of Detection",
        name: "pod",
});
variables.push({
        displayName: "False Alarm Rate",
        name: "far",
});
variables.push({
        displayName: "Bias",
...
periods.push({
        displayName: "Day 2 Daily Max (All Thresholds)",
        name: "FHO48",
});
periods.push({
        displayName: "Day 2 Daily Max (>70ppb Timeseries)",
        name: "GT7048",
});
periods.push({
        displayName: "Day 1 Daily Max (All Thresholds)",
        name: "FHO24",
});
periods.push({
        displayName: "Day 1 Daily Max (>70ppb Timeseries)",
        name: "GT7024",
});
