...
<br> Automatically set Map Type = Taylor if Statistic = Taylor, vice versa
...
var url = "https://www.emc.ncep.noaa.gov/mmb/hchuang/ftp/DDD_CMAQ_LLL_VVVPPP_FDY_CYC_YYSSS.png";
...
periods.push({
        displayName: "Hourly Time Series by Valid Date",
        name: "SERIES",
...
fcstdays.push({
        displayName: "Day 1 Forecast",
        name: "DAY1",
});
fcstdays.push({
        displayName: "Day 2 Forecast",
        name: "DAY2",
});
fcstdays.push({
        displayName: "Day 3 Forecast",
        name: "DAY3",
});
