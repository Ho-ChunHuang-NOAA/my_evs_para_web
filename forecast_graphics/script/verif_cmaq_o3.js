...
function load_imageP1(frm){
   ...
   if ( flag_continue == "yes" ) {
     if ( new_day > mcday ) {
      ...
      alert("The next day should remain in 2020/09, 2022/07, 2022/08, 2022/12, and 2023/*");
   }
}
function load_imageM1(frm){
   ...
   if ( flag_continue == "yes" ) {
     if ( new_day > mcday ) {
      ...
      alert("The day before should remain in 2020/09, 2022/07, 2022/08, 2022/12, 2023/*");
   }
}
